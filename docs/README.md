...
- **Язык документации — русский, язык кода — английский.** Комментарии, KDoc, имена тестов и
  сообщения исключений пишутся по-английски: библиотека открытая. Подробнее — в
